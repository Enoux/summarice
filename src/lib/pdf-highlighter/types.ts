import type { PdfHighlighterTheme } from './lib/theme';
...
/** Raw outline node from PDF.js */
export interface PdfOutlineItemRaw {
	title: string;
	bold: boolean;
	italic: boolean;
...
export type PdfHighlighterUtils = {
	...
	setTip(state: Partial<TipContainerState> | null): void;
