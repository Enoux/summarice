<script lang="ts" module>
	...
	import type {
		PDFDocumentProxy as ModulePDFDocumentProxy,
		OnProgressParameters as ModuleOnProgressParameters
	} from 'pdfjs-dist';
	...
	export interface PdfLoaderProps {
		 ...
		 */
		document: Parameters<(typeof import('pdfjs-dist'))['getDocument']>[0];
		 ...
		 */
		beforeLoad?: Snippet<[ModuleOnProgressParameters]>;
		 ...
		 */
		pdfHighlighterWrapper: Snippet<[ModulePDFDocumentProxy]>;
...
<script lang="ts">
	...
	import type { PDFDocumentLoadingTask, PDFDocumentProxy, OnProgressParameters } from 'pdfjs-dist';
