...
// NOTE on paragraph id contract: MockSummaryContent sets id="summary-citation-{highlight.id}"
...
describe('MockSummaryContent paragraph rendering', () => {
	...
	it('renders 3 ordinal pills for valid citations (1, 2, 1) and 1 null pill for unknown ordinal 999', () => {
		const result = render(MockSummaryContent, { props: { markdown, highlights } });
...
describe('MockSummaryContent heading id wiring', () => {
